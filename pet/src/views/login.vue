  ...
  <div class="login-wrap">
    ...
    >
      ...
      <el-form-item prop="role">
        <el-radio-group v-model="ruleForm.role" style="color: #fff">
      ...
      <el-link type="info" @click="goto">游客模式进入</el-link>
      <el-link type="primary" @click="res">注册帐号</el-link>
    </el-form>
  ...
  methods: {
    ...
    submitForm1(editData) {
      this.$refs[editData].validate(valid => {
        if (valid) {
          axios
            .post(this.httpUrl + 'user/add', this.editForm)
            .then((res) => {
